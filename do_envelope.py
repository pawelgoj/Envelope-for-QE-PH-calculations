...
if ir_raman != name_obw_2:
    raman_envelpe = Envelope(raman, nr_points, minimum, maximum).do_envelope(type_of_band, Q1, Q2)
    print("raman envelope done")
if ir_raman != name_obw_1:
    ir_envelpe = Envelope(ir, nr_points, minimum, maximum).do_envelope(type_of_band, Q1, Q2)
